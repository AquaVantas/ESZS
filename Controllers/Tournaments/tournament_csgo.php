<?php 
    ...
    $subject = "Prijava na CS2";
    $subject2 = "Prijava na CS2";
    $message = "Prijava na CS2:
...
vaša prijava na Slovensko državno prvenstvo v CS2 je bila uspešno izvedena.
...
Za dodatne informacije smo vam na voljo na info@eszs.si ali na discord server pod #vprašanja.";
	...
	if($_POST['name'] != NULL) {
	    tournament::addPlayerCS($team, $name, $surname, $from, $discord, $nickname, $dateofbirth, $postalcode);
        tournament::addPlayerCS($team, $name2, $surname2, $from2, $discord2, $nickname2, $dateofbirth2, $postalcode2);
        tournament::addPlayerCS($team, $name3, $surname3, $from3, $discord3, $nickname3, $dateofbirth3, $postalcode3);
        tournament::addPlayerCS($team, $name4, $surname4, $from4, $discord4, $nickname4, $dateofbirth4, $postalcode4);
        tournament::addPlayerCS($team, $name5, $surname5, $from5, $discord5, $nickname5, $dateofbirth5, $postalcode5);
        if($_POST['name6'] != NULL) {
            tournament::addPlayerCS($team, $name6, $surname6, $from6, $discord6, $nickname6, $dateofbirth6, $postalcode6);
        }
        if($_POST['name7'] != NULL) {
            tournament::addPlayerCS($team, $name7, $surname7, $from7, $discord7, $nickname7, $dateofbirth7, $postalcode7);
        }
	}
