			...
			<div class="create-user">
				<div class="col-12">
					<div class="edit-cloud website-default row">
						...
						<div class="col-2">
							<label for="footer_documents">Dokumenti noge:</label>
						</div>
						<div class="col-10">
							<?php $innerButtonCounter = 0; 
							foreach(website::getWebsiteDocumentation($lang_id) as $button) { 
							...
							?>
							<a class="add-block-content" href="Controllers/Website/Page/website_create_default_button.php?lang_id=<?= $lang_id ?>&default_table=document">
