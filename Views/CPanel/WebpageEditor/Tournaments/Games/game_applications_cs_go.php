...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
        <table>
            ...
            <tbody>
            <?php foreach(tournament::getPlayerCS2($game['apply_end_time'], $game['apply_start_time']) as $application) { ?>
                <tr>
                    <td><?= $application['player_name'] ?></td>
                    <td><?= $application['player_surname'] ?></td>
                    <td><?= $application['email'] ?></td>
                    <td><?= $application['discord'] ?></td>
                    <td><?= $application['steam_id'] ?></td>
            ...
            <form class="row" id="addMatchForm" onsubmit="addMatch(event, 5, <?= $_GET['tournament_id'] ?>)">
                <div class="col-12 col-lg-4">
                    ...
                    <select id="playerOne" name="playerOne" required>
                        <?php foreach(tournament::getTeamsCS2($game['apply_end_time'], $game['apply_start_time']) as $team) { ?>
                        ...
                        if($match['match_end'] != 1) { ?>                        
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="match-wrapper">
                                    <div class="vs-logos">
                                        <div class="team-logo">
                                            <?php foreach(tournament::getTeamCS2($game['apply_end_time'], $game['apply_start_time'], $match['player_one']) as $team) { 
                                                if($team['logo']) { ?>
                                        ...
                                        <h4>VS</h4>
                                        <div class="team-logo">
                                        <?php foreach(tournament::getTeamCS2($game['apply_end_time'], $game['apply_start_time'], $match['player_two']) as $team) { 
                                                if($team['logo']) { ?>
