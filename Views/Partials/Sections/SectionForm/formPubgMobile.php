	...
	<div class="container" style="padding-top: 50px;">
		<div class="row">
			...
			<?php foreach(website::getWebsiteSectionForm($section_type['section_id']) as $sectionForm) {
				...
				<form method="post" action="Controllers/Tournaments/tournament_pubg_mobile.php"><br>
					...
					<label for="ingameId7">Id v igri:</label><br>
					<input type="text" id="ingameId7" name="ingameId7" placeholder="218391"><br>
					<label for="nationality7">Državljanstvo:</label><br>
					<input type="text" id="nationality7" name="nationality7" placeholder="slovensko"><br>
