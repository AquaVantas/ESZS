		...
		<div class="row">
			...
			<div class="col-xxl-8 col-xl-8 col-lg-8" style="padding-bottom: 70px;">
				<?php foreach(website::getWebsiteSectionForm($section_type['section_id']) as $sectionForm) {
					...
					<form method="post" action="Controllers/Tournaments/tournament_fifa.php?section_id=<?= $section_type['section_id'] ?>">
						<table width="100%">
							<tr>
						...
						<label for="platform">Platform: <span style="color: red;">*</span></label><br>
						<select name="platform" id="platform">
							<option value="Playstation 5">Playstation 5</option>
							<option value="PC">PC</option>
						</select><br>
						<label for="term">Termin kvalifikacij: <span style="color: red;">*</span></label><br>
						<select name="term" id="term">
							<option value="1. kvalifikacije (4. 11. 2024)">1. kvalifikacije (4. 11. 2024)</option>
							<option value="2. kvalifikacije (5. 11. 2024)">2. kvalifikacije (5. 11. 2024)</option>
						</select><br>
